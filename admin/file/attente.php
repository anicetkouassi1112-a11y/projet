...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $action !== '') {
    ...
    try {
        $success = appContainer()->get(\Patro\Domain\Inscription\Repository\InscriptionRepository::class)
            ->transitionState($idInscription, 'En attente', 'inscrit');
...
try {
    ...
    $inscriptions = appContainer()->get(\Patro\Domain\Inscription\Repository\InscriptionRepository::class)
