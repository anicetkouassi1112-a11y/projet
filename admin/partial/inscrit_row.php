...
$genreNormalized = \Patro\Domain\Inscription\Genre::normalize($genreRaw);
...
$showSectionColumn = $showSectionColumn ?? appContainer()->get(\Patro\Inscription\SessionService::class)->sectionBreakdownEnabled($typeSessionActive);
